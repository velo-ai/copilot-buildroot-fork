...
# Copilot specific
#
# 1. Update the version to latest.
# 2. Build the python bindings.  In addition to enabling the option we have to
# override Buildroot's desire to disable subproject wraps.
# 3. The subproject wrap hits an https server for the pybind11 subproject and
